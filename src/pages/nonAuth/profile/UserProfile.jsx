    ...
    <div className="w-full bg-white">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm font-medium text-gray-900 whitespace-pre-line">{user.address}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-900">Email Newsletter</p>
                  <p className="text-xs text-gray-500">Receive product updates and news</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" checked={user.preferences.newsletter} className="sr-only peer" />
              ...
              <div className="flex items-center justify-between">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" checked={user.preferences.darkMode} className="sr-only peer" />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-black"></div>
                </label>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto p-6 md:p-8 border-t border-gray-200">
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="px-6 py-3 flex-1 max-w-xs mx-auto flex items-center justify-center space-x-2 bg-white border border-gray-300 rounded-md hover:bg-gray-100">
